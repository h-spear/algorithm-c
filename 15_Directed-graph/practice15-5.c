...
int main()
{
	...
	insertDirectEdge(&g, 2, 4);
	insertDirectEdge(&g, 3, 2);
	insertDirectEdge(&g, 3, 4);
	insertDirectEdge(&g, 4, 5);
	insertDirectEdge(&g, 5, 6);
	insertDirectEdge(&g, 5, 7);
	insertDirectEdge(&g, 5, 8);
	insertDirectEdge(&g, 6, 7);
	insertDirectEdge(&g, 8, 7);
